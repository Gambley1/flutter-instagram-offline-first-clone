...
class _CustomTransitionPageRoute<T> extends PageRoute<T> {
  _CustomTransitionPageRoute(AppTransitionPage<T> page)
      : super(settings: page);

  AppTransitionPage<T> get _page => settings as AppTransitionPage<T>;
...
class NoTransitionPage<T> extends AppTransitionPage<T> {
